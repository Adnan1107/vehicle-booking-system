...
export default function BookingSuccess() {
    ...
    return (
      <div className="max-w-md mx-auto px-4 sm:px-6 py-20 text-center">
        ...
        <button
          ...
          className="mt-6 px-5 py-2.5 rounded-xl bg-red-600 text-white font-semibold text-sm hover:bg-red-500 transition-colors"
        >
          Back to Vehicles
        </button>
      </div>
  ...
  return (
    <div className="max-w-lg mx-auto px-4 sm:px-6 py-16 text-center">
      ...
      <p className="text-neutral-500 mt-2">
        Your vehicle booking has been successfully submitted.
      </p>
      ...
      <div className="text-left bg-white rounded-2xl border border-neutral-200 shadow-sm p-6 mt-8 space-y-3">
        ...
        <Row
          label="Total Amount"
          value={`₹${Number(booking.total_amount || 0).toLocaleString('en-IN')}`}
        />
